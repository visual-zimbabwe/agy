...
const PAGE_WORKSPACE_PANEL =
  "rounded-[14px] border border-white/8 bg-[color:rgb(8_11_16_/_0.9)] text-white shadow-[0_14px_34px_rgba(0,0,0,0.34)] backdrop-blur-md";
const PAGE_WORKSPACE_BUTTON =
  "inline-flex items-center gap-2 rounded-[10px] border border-white/8 bg-[color:rgb(255_255_255_/_0.03)] px-2.5 py-1.5 text-[10px] font-medium text-white/72 transition hover:bg-[color:rgb(255_255_255_/_0.08)] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4f9cd6] focus-visible:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-45";
const PAGE_WORKSPACE_ICON_BUTTON =
  "inline-flex h-8 w-8 items-center justify-center rounded-[10px] border border-white/8 bg-[color:rgb(255_255_255_/_0.03)] text-white/72 transition hover:bg-[color:rgb(255_255_255_/_0.08)] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4f9cd6] focus-visible:ring-offset-0";
const PAGE_WORKSPACE_TOOL_BUTTON =
  "group flex h-10 w-10 items-center justify-center rounded-[10px] border border-white/8 bg-[color:rgb(255_255_255_/_0.03)] text-white/72 transition hover:bg-[color:rgb(255_255_255_/_0.08)] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4f9cd6] focus-visible:ring-offset-0";
    ...
    <main className="route-shell page-workspace-shell text-[var(--color-text)]">
      ...
      <div className="pointer-events-none absolute inset-0 z-30">
        <div className="absolute inset-x-3 top-3 flex items-start justify-between gap-3">
          <div className={`${PAGE_WORKSPACE_PANEL} pointer-events-auto flex min-w-0 items-center gap-3 px-3 py-2`}>
            <div className="flex h-8 w-8 items-center justify-center rounded-[10px] border border-white/10 bg-[color:rgb(79_156_214_/_0.14)] text-[10px] font-semibold tracking-[0.22em] text-white/88">
              PG
            </div>
            <div className="min-w-0">
              <p className="text-[9px] uppercase tracking-[0.22em] text-white/34">Infinite Editor</p>
              <p className="truncate text-xs font-semibold text-white/88">{workspaceDocLabel || "Main Canvas"}</p>
            </div>
            <div className="hidden items-center gap-1.5 md:flex">
              <span className="rounded-full border border-white/8 bg-white/4 px-2 py-0.5 text-[9px] uppercase tracking-[0.16em] text-white/46">{blocks.length} blocks</span>
              <span className="rounded-full border border-white/8 bg-white/4 px-2 py-0.5 text-[9px] uppercase tracking-[0.16em] text-white/46">{Math.round(camera.zoom * 100)}%</span>
            </div>
          </div>
          <div className={`${PAGE_WORKSPACE_PANEL} pointer-events-auto flex items-center gap-1.5 px-1.5 py-1.5`}>
            ...
            <button type="button" className={PAGE_WORKSPACE_BUTTON} onClick={fitWorkspaceView} disabled={blocks.length === 0}>Fit</button>
        ...
        <div className={`absolute left-3 top-17 hidden p-1.5 md:block ${PAGE_WORKSPACE_PANEL}`}>
          <div className="flex flex-col gap-1.5">
            {workspaceTools.map((tool) => (
              <button key={tool.id} type="button" className={`${PAGE_WORKSPACE_TOOL_BUTTON} pointer-events-auto`} onClick={tool.onClick} title={`${tool.label} - ${tool.hint}`} aria-label={tool.label}>
                <span className="text-[10px] font-semibold uppercase tracking-[0.14em]">{tool.glyph}</span>
              </button>
            ))}
          </div>
        </div>

        <div className={`absolute bottom-3 left-1/2 flex w-[min(32rem,calc(100%-1.5rem))] -translate-x-1/2 items-center justify-between gap-3 px-2.5 py-2 ${PAGE_WORKSPACE_PANEL}`}>
          <div className="min-w-0">
            <p className="truncate text-[11px] font-medium text-white/82">{primarySelectedBlock ? `Selected ${primarySelectedBlock.type}` : "Canvas ready"}</p>
            <p className="truncate text-[9px] uppercase tracking-[0.18em] text-white/38">Pan drag. Ctrl/Cmd + wheel zoom. Slash inside text.</p>
          </div>
          <div className="pointer-events-auto flex items-center gap-1.5">
            ...
            <div className="min-w-[3.8rem] rounded-[10px] border border-white/8 bg-white/4 px-2 py-1.5 text-center text-[10px] font-semibold text-white/72">{Math.round(camera.zoom * 100)}%</div>
            ...
            <button type="button" className={PAGE_WORKSPACE_BUTTON} onClick={duplicatePrimaryBlock} disabled={!primarySelectedBlockId}>Dup</button>
          </div>
        </div>

        <div className="absolute inset-[10px] rounded-[18px] border border-white/6 shadow-[inset_0_1px_0_rgba(255,255,255,0.05),0_24px_60px_rgba(0,0,0,0.22)]" />
      </div>
      ...
      >
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute inset-[10px] rounded-[18px] bg-[linear-gradient(180deg,rgba(242,245,248,0.96)_0%,rgba(236,240,244,0.94)_100%)]" />
          <div className="absolute inset-[10px] rounded-[18px] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.2)]" />
        </div>
        <div
