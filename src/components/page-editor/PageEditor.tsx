...
const potteryTemplateLines: Array<{ type: BlockType; content: string }> = [
  ...
  { type: "text", content: "Nyanga High School Marist Brothers, Zimbabwe | Visual and Performing Arts (Art and Design - Pottery) | Time Allocation: 4 periods/week (2 double practical blocks) | Intended for MoPSE submission as elective/enrichment." },
  { type: "text", content: "Implementation cycle: 2026 onward | Learner age band: approx. 12-16 years | Exit pathway: Form 4 practical and theory readiness for O-Level visual arts progression." },
  { type: "h2", content: "1. Preamble" },
  { type: "text", content: "This syllabus aligns with Zimbabwe's Heritage-Based Curriculum Framework (2024-2030). It develops practical pottery competence, creativity, innovation, entrepreneurship, and Ubuntu/Unhu values while preserving local cultural heritage." },
  { type: "text", content: "The course combines heritage interpretation, design process, material science, and enterprise. Learners produce functional and sculptural ceramic outcomes informed by Zimbabwean visual language and community context." },
  { type: "text", content: "Instructional spine each week: Technical Throw Down (targeted timed skill), Main Make (applied design challenge), Group Critique (structured reflection and feedback)." },
  ...
  { type: "bulleted", content: "Prepare learners for further study, creative industry opportunities, and local livelihood applications." },
  ...
  { type: "numbered", content: "Diagnose and correct common defects: cracking, warping, glaze crawling, pinholing, weak joins, and firing faults." },
  { type: "numbered", content: "Communicate design intent verbally and in writing using correct art and design terminology." },
  { type: "numbered", content: "Demonstrate inclusion, collaboration, and responsible studio behavior." },
  ...
  { type: "bulleted", content: "Cross-curricular integration: science (clay chemistry and firing), mathematics (scale/proportion/costing), history/heritage studies (artifact interpretation), business (pricing and sales records), ICT (digital portfolio)." },
  { type: "bulleted", content: "Resource model for under-resourced contexts: shared wheel stations, local clay preparation, staged firing schedule, reclaim workflow, low-cost tool fabrication." },
  { type: "h2", content: "5. Core Topics and Subtopics" },
  { type: "h3", content: "5.1 Materials and Studio Systems" },
  { type: "bulleted", content: "Clay sourcing ethics, processing, wedging, reclaiming, moisture control, storage." },
  { type: "bulleted", content: "Tool care, workstation setup, quality control logs, production planning." },
  { type: "h3", content: "5.2 Forming and Construction" },
  { type: "bulleted", content: "Pinch, coil, slab, moulding, wheel-throwing, sectional assembly, trimming." },
  { type: "bulleted", content: "Handles, lids, spouts, feet, thickness consistency, balance and stability." },
  { type: "h3", content: "5.3 Surface and Finishing" },
  { type: "bulleted", content: "Burnishing, incising, stamping, carving, slip trailing, sgraffito, underglaze/glaze testing." },
  { type: "bulleted", content: "Motif development from Zimbabwean craft patterns and symbolic language." },
  { type: "h3", content: "5.4 Firing and Safety" },
  { type: "bulleted", content: "Drying protocol, bisque process, glaze firing basics, kiln logs, defect diagnosis." },
  { type: "bulleted", content: "Dust control, PPE, hazard communication, emergency and incident procedures." },
  { type: "h3", content: "5.5 Enterprise and Portfolio" },
  { type: "bulleted", content: "Pricing, costing sheets, quality standards, product photography, display and packaging." },
  { type: "bulleted", content: "Market day planning, customer feedback, reflective improvement cycle." },
  { type: "h2", content: "5. Topics" },
  { type: "text", content: "Note: Section retained for MoPSE format continuity. Detailed topic map is provided in 5.1 to 5.5 above." },
  { type: "h2", content: "6. Scope and Sequence" },
  { type: "h3", content: "Form 1 (Foundation)" },
  { type: "bulleted", content: "Term 1 focus: induction, clay body basics, studio rules, pinch and coil control." },
  { type: "bulleted", content: "Weekly challenge examples: uniform pinch cups, coil wall-thickness drill, join-strength test." },
  { type: "bulleted", content: "Main make: family utility set (2 bowls + 1 cup) with process journal." },
  { type: "bulleted", content: "Term 2 focus: slab work, measurement accuracy, texture and motif transfer." },
  { type: "bulleted", content: "Main make: Nyanga landscape story tile panel; critique on symbolism and readability." },
  { type: "bulleted", content: "Term 3 focus: handles/lids, controlled drying, first bisque awareness." },
  { type: "bulleted", content: "Main make: lidded storage pot inspired by local vessel function and form." },
  { type: "text", content: "Alternative Project: seed-saving jar set for Agriculture Club." },
  { type: "h3", content: "Form 2 (Intermediate)" },
  { type: "bulleted", content: "Term 1 focus: wheel entry, centering control, form-function evaluation." },
  { type: "bulleted", content: "Main make: functional mug line with Zimbabwean motif variants and design statement." },
  { type: "bulleted", content: "Term 2 focus: repeatability and set consistency across dimensions and finish quality." },
  { type: "bulleted", content: "Main make: tea-for-two service set with quality control checklist." },
  { type: "bulleted", content: "Term 3 focus: slip, colour layering, glaze tests, fit and finish." },
  { type: "bulleted", content: "Main make: decorative water jug with narrative band and pour test." },
  { type: "text", content: "Alternative Project: proverb mug series for community exhibition." },
  { type: "h3", content: "Form 3 (Advanced)" },
  { type: "bulleted", content: "Term 1 focus: advanced wheel forms, sectional joining, balancing mass and function." },
  { type: "bulleted", content: "Main make: teapot/jug challenge (leak-proof, ergonomic, culturally grounded)." },
  { type: "bulleted", content: "Term 2 focus: conceptual sculptural ceramics and narrative composition." },
  { type: "bulleted", content: "Main make: Ubuntu in Clay sculpture with artist statement and oral defense." },
  { type: "bulleted", content: "Term 3 focus: production workflow and entrepreneurship prototype cycle." },
  { type: "bulleted", content: "Main make: 3-item market line with costing sheet and customer test feedback." },
  ...
  { type: "bulleted", content: "Term 1 focus: specialization proposal, benchmark studies, measured replication tasks." },
  { type: "bulleted", content: "Main make: contemporary heritage tableware brief with annotated iterations." },
  { type: "bulleted", content: "Term 2 focus: capstone development, technical troubleshooting, refinement and curation." },
  { type: "bulleted", content: "Main make: capstone production sequence with defect correction log." },
  { type: "bulleted", content: "Term 3 focus: exam simulation, exhibition management, portfolio defense." },
  { type: "bulleted", content: "Main make: final curated showcase, enterprise pitch, and viva presentation." },
  { type: "text", content: "Alternative Project: social-impact ceramics project." },
  { type: "h2", content: "7. Competency Matrix" },
  { type: "bulleted", content: "Form 1: knowledge - clay and safety fundamentals | skills - basic hand-building | attitudes - care, teamwork, curiosity." },
  { type: "bulleted", content: "Form 2: knowledge - form-function and glaze entry | skills - wheel basics and consistency | attitudes - precision, persistence." },
  { type: "bulleted", content: "Form 3: knowledge - production systems and defect logic | skills - complex forms and enterprise prototype | attitudes - accountability and initiative." },
  { type: "bulleted", content: "Form 4: knowledge - project curation and exam strategy | skills - capstone execution and defense | attitudes - leadership, professionalism, innovation." },
  { type: "h2", content: "8. Assessment Framework and Grade Distribution" },
  { type: "text", content: "Total suggested marks per year: 1000 points equivalent. Final weighting may be moderated to match active school and ZIMSEC requirements at implementation year." },
  { type: "bulleted", content: "Continuous Assessment (60%): Technical Throw Downs 15%, Main Makes 25%, Portfolio 15%, Critique/Professional Conduct 5%." },
  { type: "bulleted", content: "Summative Assessment (40%): Practical Examination 25%, Written Paper 10%, Viva/Exhibition Defense 5%." },
  { type: "h3", content: "8.1 Major Components (Detailed)" },
  { type: "numbered", content: "Technical Throw Down Series: weekly rubric scoring on precision, speed, finish, and safety compliance." },
  { type: "numbered", content: "Main Make Projects: term capstone with process evidence, cultural rationale, and functional/performance tests." },
  { type: "numbered", content: "Portfolio: sketchbook, references, clay/glaze tests, firing logs, reflection journals, photos, costing sheets." },
  { type: "numbered", content: "Written Theory Tasks: heritage analysis, materials science, design reasoning, enterprise planning." },
  { type: "numbered", content: "Final Exhibition and Viva: curated display, oral defense, and critique response." },
  { type: "h3", content: "8.2 Rubric Model (Per Practical Task)" },
  { type: "bulleted", content: "Band 4 (Excellent): full technical control, strong design originality, clear heritage integration, polished finish, reflective insight." },
  { type: "bulleted", content: "Band 3 (Competent): good control, mostly complete outcomes, appropriate motif use, minor defects." },
  { type: "bulleted", content: "Band 2 (Developing): partial control, uneven execution, limited analysis, repeated support required." },
  { type: "bulleted", content: "Band 1 (Beginning): insufficient control, incomplete outcomes, weak process evidence." },
  { type: "h2", content: "9. Weekly Outline Reference (Sample 15-Week Cycle Per Year)" },
  { type: "bulleted", content: "Week 1: Induction, safety, baseline diagnostic task." },
  { type: "bulleted", content: "Week 2: Material science mini-lab and forming drill." },
  { type: "bulleted", content: "Week 3: Technical Throw Down 1 and feedback conference." },
  { type: "bulleted", content: "Week 4: Main Make brief issue and design ideation." },
  { type: "bulleted", content: "Week 5: Build phase 1 with process documentation." },
  { type: "bulleted", content: "Week 6: Build phase 2 and peer critique checkpoint." },
  { type: "bulleted", content: "Week 7: Finishing and defect correction clinic." },
  { type: "bulleted", content: "Week 8: Firing and evaluation logs." },
  { type: "bulleted", content: "Week 9: Technical Throw Down 2." },
  { type: "bulleted", content: "Week 10: Heritage research integration and redesign." },
  { type: "bulleted", content: "Week 11: Enterprise costing and packaging." },
  { type: "bulleted", content: "Week 12: Main Make finalization." },
  { type: "bulleted", content: "Week 13: Exhibition preparation and artist statement drafting." },
  { type: "bulleted", content: "Week 14: Practical assessment and viva." },
  { type: "bulleted", content: "Week 15: Reflection, moderation, target-setting for next cycle." },
  { type: "h2", content: "10. Safety, Inclusion, and Welfare Policies" },
  { type: "bulleted", content: "No unsupervised kiln operation; signed firing checklist mandatory each cycle." },
  { type: "bulleted", content: "Wet-cleaning protocol for dust; PPE for sanding/glazing; first-aid and incident register maintained." },
  { type: "bulleted", content: "Adaptive participation plan for learners with disabilities: tool adaptation, timing flexibility, alternative evidence pathways." },
  { type: "bulleted", content: "Professional conduct standard: respectful critique, no harassment, responsible tool use, and clean-up accountability." },
  { type: "h2", content: "11. Resource Plan and Budgeting" },
  { type: "bulleted", content: "Essential resources: local clay, sieves, buckets, wedging boards, carving tools, trimming tools, shared wheel, kiln, shelves, cones, PPE." },
  { type: "bulleted", content: "Low-cost substitutions: improvised ribs, recycled templates, shared studio stations, rotational wheel timetable." },
  { type: "bulleted", content: "Consumables tracking: clay usage ledger, glaze test records, breakage register, maintenance log." },
  { type: "h2", content: "12. Entrepreneurship and Community Interface" },
  { type: "bulleted", content: "Form 2: basic pricing and simple invoice records." },
  { type: "bulleted", content: "Form 3: customer persona mapping, prototype testing, and product iteration." },
  { type: "bulleted", content: "Form 4: brand concept, exhibition sales pitch, and post-sale evaluation report." },
  { type: "bulleted", content: "Ethics: cultural respect, authenticity, fair attribution of heritage motifs, and non-exploitative commercialization." },
  { type: "h2", content: "13. Quality Assurance and Moderation" },
  { type: "bulleted", content: "Internal moderation each term using common rubrics and sampled portfolios." },
  { type: "bulleted", content: "Cross-form moderation meetings to ensure progressive standards." },
  { type: "bulleted", content: "Annual syllabus review informed by learner outcomes, resource constraints, and community feedback." },
  { type: "h2", content: "14. Administrative Notes" },
  { type: "bulleted", content: "This is a draft teaching document for departmental review and MoPSE-aligned submission packaging." },
  { type: "bulleted", content: "Attach school calendar mapping, staff deployment plan, resource audit, and district approval page before final submission." },
