...
export const toolbarSurface =
  "rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface-elevated)] p-1.5 shadow-[var(--shadow-md)] backdrop-blur-[var(--blur-panel)] motion-panel-enter";
...
export const toolbarBtnActive =
  `${toolbarBtnBase} border-[var(--color-focus)] bg-[color:rgb(2_132_199_/_0.10)] text-[color:rgb(4_104_156)] shadow-[var(--shadow-sm)] hover:bg-[color:rgb(2_132_199_/_0.16)]`;

export const toolbarBtnAccent =
  `${toolbarBtnBase} border-[color:rgb(59_130_246_/_0.55)] bg-[color:rgb(219_234_254_/_0.72)] text-[color:rgb(30_64_175)] hover:bg-[color:rgb(219_234_254)]`;
